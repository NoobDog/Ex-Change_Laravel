	...
	public function getCountries() {
		...
		public function addAddress (Request $request) {
			...
			if(empty($checkAddress)) {
				DB::insert('INSERT INTO address (userID, userCountry, userProvince, userCity, userAddress, userPostalCode, isVoid, adminID)
					values (?, ?, ?, ?, ?, ?, ?, ?)',
					[Session::get('userID'), $userCountry, $userProvince, $userCity, $userAddress, $userPostalCode, 0, 0]
				);
			}else {
				DB::update('UPDATE address SET userCountry = ?, userProvince = ?, userCity = ?, 
					userAddress = ?, userPostalCode = ? where userID = ?', 
